...
const contactInfo = [
  ...
  },
  {
    ...
    primary: 'Jaffna, Sri Lanka',
    secondary: 'Northern Province',
  },
  {
    icon: ClockIcon,
    title: 'Hours',
  ...
  },
  {
    icon: GlobeAltIcon,
    title: 'Coverage',
    description: 'We serve clients across Sri Lanka',
    primary: 'Sri Lanka Wide',
    secondary: 'Remote Support Available',
  },
  {
