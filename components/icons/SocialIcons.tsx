...
const socialLinks = [
  {
    name: 'LinkedIn',
    href: 'https://linkedin.com/company/5xcodes',
    icon: (
  ...
  {
    name: 'Twitter',
    href: 'https://twitter.com/5xcodes',
    icon: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
  ...
  {
    name: 'YouTube',
    href: 'https://youtube.com/@5xcodes',
    icon: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
...
// Individual icon components for use in other components
