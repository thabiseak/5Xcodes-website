...
export function CloudSolutionsHero() {
  ...
  const features = [
    { icon: CloudIcon, text: 'Cloud Migration' },
    { icon: ServerIcon, text: 'Infrastructure Setup' },
    { icon: ShieldCheckIcon, text: 'Security & Compliance' },
    { icon: ChartBarIcon, text: 'Performance Optimization' },
    { icon: CogIcon, text: 'DevOps Automation' },
    { icon: RocketLaunchIcon, text: 'Scalable Architecture' },
  ];
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        ...
        >
          ...
          >
            ...
            Migrate, optimize, and scale your applications in the cloud.
          </motion.p>
