...
export function CustomDevelopmentHero() {
  ...
  const features = [
    { icon: CodeBracketIcon, text: 'Full-Stack Development' },
    { icon: CpuChipIcon, text: 'API Integration' },
    { icon: CloudIcon, text: 'Cloud Architecture' },
    { icon: ShieldCheckIcon, text: 'Security First' },
    { icon: RocketLaunchIcon, text: 'Scalable Solutions' },
    { icon: ChartBarIcon, text: 'Performance Optimized' },
  ];
