...
export function ProductsHero() {
  ...
  const productCategories = [
    { icon: RocketLaunchIcon, text: 'SaaS Tools' },
    { icon: ChartBarIcon, text: 'Analytics' },
    { icon: BuildingOfficeIcon, text: 'Enterprise' },
    { icon: CloudIcon, text: 'Cloud Native' },
    { icon: ShieldCheckIcon, text: 'Security' },
    { icon: CogIcon, text: 'Automation' },
  ];
    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-gray-50 via-white to-gray-100">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        ...
        >
          ...
          >
            Discover our cutting-edge software products designed to accelerate your business growth. 
            From SaaS tools to enterprise solutions, we build the future of business software.
          </motion.p>
