...
export function PortfolioCTA() {
  ...
  const contactMethods = [
    ...
    },
    {
      ...
      action: 'projects@5xcodes.com',
      color: 'from-green-400 to-emerald-500'
    },
    {
      icon: ChatBubbleLeftRightIcon,
      title: 'Live Chat',
      description: 'Get instant project consultation',
      action: 'Start Chat',
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-2xl mx-auto">
            Get a free consultation and detailed project proposal. No obligations, 
            just expert advice on how to bring your vision to life.
          </p>
          ...
          <div className="mt-8 text-sm text-gray-400">
            <p>✓ Free consultation & project proposal</p>
